<?php
    ...
    //   validateToken();
        ...
        if($jsonIndex == NULL)
        {
            ...
            $startTime = $dbDataArr[$jsonIndex]['events'][1]/30.;
            $maxFrame = $dbDataArr[$jsonIndex]['events'][7] - $dbDataArr[$jsonIndex]['events'][1];
            $id = $dbDataArr[$jsonIndex]['id'];
            $partsOfBody =filter_input(INPUT_POST,'parts_Body',FILTER_DEFAULT, FILTER_REQUIRE_ARRAY);
        }
...
<body>
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <!-- <div class="carousel-inner">
                                ...
                                <li class="mb-2">動画が読み込まれたら、「その他の動画」と広告を消してから始めるボタンを押してください</li>
                                <img src="../../app/tutorials/tutorial-yt.gif" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
            ...
            <div class="col-2">
                ...
                <input type="hidden" name="movieName" value="<?= $fileName."/".$jsonIndex?>">
    ...
    <div id="target" style="aspect-ratio: 16/9;">
        <table id="table" class="table table-light opacity-75 overflowscroll position-absolute end-0 mt-2 me-2" style="z-index: -10; width: 240px;" >
            <thead>
                <tr>
    ...
    <div class="container-fluid mb-5 justify-content-between">
        <div class="row align-items-center justify-content-between">
        <div class="col-2">
            <button id="start" class="btn btn-primary">始める</button>
        </div>
        <div class="col-7 d-flex justify-content-between align-items-center bg-dark rounded" style="width: 450px;">
            ...
            <div class="d-flex justify-content-center align-items-center text-white" style="height: 40px; width: 230px; text-align:center; margin:auto;">
                id:&nbsp;<?=$id?>
                &emsp;
        ...
        <div class="col-2">
            ...
            <button id="table-display" class="btn btn-secondary" style="">表の表示/非表示</button>
            </div>
        </div>
        </div>
    </div>
    ...
    <script type="text/javascript" src="../../youtubePlot.js"></script>
